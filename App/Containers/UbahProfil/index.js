...
const UbahProfil = (props) => {
  ...
  let ubahprofil = t('common:ubahProfil');
  ...
  let txt_konfirmdelacct = t('common:txt_konfirmdelacct');
  let batal = t('common:batal');
  let oke = t('common:oke');
  let yakin = t('common:yakin');
  let err_update = t('common:err_update');
  let informasi = t('common:informasi');
  let profil_update = t('common:profil_update');
  let kamera = t('common:kamera');
  let galeri = t('common:Galeri');
  let foto_profil  = t('common:foto_profil');
  let inf_ubhsandi = t('common:inf_ubhsandi');
        ...
        <View style={styles.viewRootModal}>
          <View style={[styles.modalBox, {backgroundColor: '#FFFFFF', height: toDp(192)}]}>
            <View style={styles.viewModalTitle}>
              ...
              <Text style={[styles.textTitleModal, {color: '#363636'}]}>{foto_profil}</Text>
  ...
  const alertdel = () => {
    Alert.alert(
      ...
      [
        ...
        { text: yakin, onPress: () => {
          console.log('hahaha');
          NavigatorService.navigate('Verification', {type:'del'});
        }}
      ]
    )
  }
      ...
      />
          <ScrollView style={styles.scrollView}>
            ...
            <View>
              ...
              <View style={{alignItems: 'center', marginTop:toDp(20)}}>
              ...
              <View style={styles.card}>
                  ...
                  <View style={styles.vimput}>
                    <Text>{t('common:fnohp')}</Text>
                    <TextInput style={styles.input} value={state.phone}  placeholder={'Optional'} keyboardType = 'numeric'
                  ...
                  <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center', marginTop:toDp(15), marginLeft:toDp(2)}}>
                      {state.login==='google' || state.login==='facebook' || state.login==='apple'?
                        <View>
                      ...
                      :
                        ...
                        <Pressable style={styles.presableSave} onPress={()=>    validate()}>
                          <Text style={{color:'#FFF'}}>{t('common:simpan')}</Text>
                        </Pressable>

                  </View>


                  <View style={{ marginTop:toDp(15), marginLeft:toDp(2)}}>
                        <Pressable onPress={()=>  alertdel()}>
                          <Text style={{color:'#DF0000'}}>{t('common:delacctext')}</Text>
                        </Pressable>
                  </View>
