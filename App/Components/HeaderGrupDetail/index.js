...
import {BackHandler, Dimensions, StyleSheet, Text, View, Image, Alert, Platform, TouchableOpacity, AsyncStorage, ScrollView, SafeAreaView} from 'react-native'
          ...
          >
...

            {
              ...
              <TouchableOpacity
                ...
                <Image source={allLogo.icCheck} style={styles.icBack} />
              </TouchableOpacity>
            }
